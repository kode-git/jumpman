...
function main() {
  ...
  faceInfos.forEach((faceInfo) => {
    ...
    image.crossOrigin = "anonymous" // cross-origin secure error management
    image.src = url; // url of the image provided by the previous object
  ...
  function drawScene(time) {
    ...
    // draw the skybox
    // let our quad pass the depth test at 1.0 for skybox
